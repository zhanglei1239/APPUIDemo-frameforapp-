...
//        UIImageView * imgBg = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"背景.jpg"]];
//        _tableView.backgroundView = imgBg;
        _tableView.backgroundColor = [UIColor colorWithHue:121/255.0 saturation:181/255.0 brightness:215/255.0 alpha:1];

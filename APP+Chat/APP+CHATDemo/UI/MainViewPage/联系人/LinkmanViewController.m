...
@interface LinkmanViewController ()<UITableViewDataSource, UITableViewDelegate, UISearchBarDelegate, UISearchDisplayDelegate, UIActionSheetDelegate, BaseTableCellDelegate, SRRefreshDelegate>
{
...
- (EMSearchDisplayController *)searchController
{
    if (_searchController == nil) {
        ...
        __weak LinkmanViewController *weakSelf = self;
